...
def train():
    ...
    if os.path.exists('/home1/rhhHD/Two-stream/model2_results/epoch46_loss0.6831_acc0.7835.pkl'):
        convnet.load_state_dict(torch.load('/home1/rhhHD/Two-stream/model2_results/epoch46_loss0.6831_acc0.7835.pkl'))
    ...
    for epoch in range(Epochs):
        ...
        with open('/home1/rhhHD/Two-stream/model2_results/' + 'train_results.csv', 'a', encoding='utf-8',
                  newline='') as f:
            csv_writer = csv.writer(f)
        ...
        if epoch_acc > best_acc:
            best_acc = epoch_acc
            pkl_name = '/home1/rhhHD/Two-stream/model2_results/' + 'epoch' + str(epoch) + '_loss' + str(
