...
from secondModel import ConVNet
...
def train():
    ...
    if os.path.exists('/Users/qujianning/Desktop/3D_Action_Recognition/secondModel_results/epoch46_loss0.6831_acc0.7835.pkl'):
        convnet.load_state_dict(torch.load('/Users/qujianning/Desktop/3D_Action_Recognition/secondModel_results/epoch46_loss0.6831_acc0.7835.pkl'))
    ...
    base_params = filter(lambda p: id(p) not in fc1_params,
                         convnet.parameters())
    optimizer = torch.optim.Adam([{'params': base_params}, {'params': convnet.fc1.parameters(), 'weight_decay': 0.01}],
    ...
    for epoch in range(Epochs):
        ...
        with open('/Users/qujianning/Desktop/3D_Action_Recognition/secondModel_results/' + 'train_results.csv', 'a', encoding='utf-8',
                  newline='') as f:
        ...
        if epoch_acc > best_acc:
            best_acc = epoch_acc
            pkl_name = '/Users/qujianning/Desktop/3D_Action_Recognition/secondModel_results/' + 'epoch' + str(epoch) + '_loss' + str(
