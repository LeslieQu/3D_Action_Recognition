...
def train():
    ...
    for epoch in range(Epochs):
        ...
        with open('/home1/rhhHD/Two-stream/model1_results/' + 'train_results.csv', 'a', encoding='utf-8',
                  newline='') as f:
            csv_writer = csv.writer(f)
        ...
        if epoch_acc > best_acc:
            best_acc = epoch_acc
            pkl_name = '/home1/rhhHD/Two-stream/model1_results/' + 'epoch' + str(epoch) + '_loss' + str(
